...
var c = (a, t, o) =>
    t in a ? ye(a, t, { enumerable: !0, configurable: !0, writable: !0, value: o }) : (a[t] = o),
  r = (a, t) => {
    for (var o in t || (t = {})) ke.call(t, o) && c(a, o, t[o]);
    if (n) for (var o of n(t)) ve.call(t, o) && c(a, o, t[o]);
    return a;
  },
  l = (a, t) => Se(a, Me(t));
import { g as s, d as Ce } from '../index.js';
import { _ as i, O as we } from './antd-BmrhB3rb.js';
...
const p = {
  ...
  Pe = { lang: p },
  $e = Object.freeze(
    Object.defineProperty({ __proto__: null, default: Pe, lang: p }, Symbol.toStringTag, {
      value: 'Module',
    }),
  ),
  g = '确认',
  ...
  $ = { searchNotData: '暂无搜索结果', toSearch: '确认', toNavigate: '切换' },
  F = { normalText: '获取验证码', sendText: '{0}秒后重新获取' },
  D = {
    selectImage: '选择图片',
    uploadSuccess: '上传成功',
    imageTooBig: '图片超限',
  ...
  j = { loadingText: '加载中...', cancelText: '关闭', okText: '确认' },
  z = { exportModalTitle: '导出数据', fileType: '文件类型', fileName: '文件名' },
  L = {
    putAway: '收起',
    unfold: '展开',
    maxTip: '字符数应小于{0}位',
  ...
  B = { placeholder: '点击选择图标', search: '搜索图标', copy: '复制图标成功!' },
  A = { search: '菜单搜索' },
  E = { cancelText: '关闭', okText: '确认', close: '关闭', maximize: '最大化', restore: '还原' },
  N = {
    settingDens: '密度',
  ...
  R = { onlinePreview: '在线预览', onlineDocument: '在线文档' },
  U = {
  ...
  Le = { footer: R, header: U, multipleTab: q, setting: W },
  Be = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Le, footer: R, header: U, multipleTab: q, setting: W },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  V = '登录',
  Q = '错误日志列表',
  Ae = { login: V, errorLogList: Q },
  Ee = Object.freeze(
    Object.defineProperty(
      { __proto__: null, default: Ae, errorLogList: Q, login: V },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  K = '工作台',
  X = '分析页',
  Ne = { dashboard: J, about: G, workbench: K, analysis: X },
  Oe = Object.freeze(
    Object.defineProperty(
      { __proto__: null, about: G, analysis: X, dashboard: J, default: Ne, workbench: K },
      Symbol.toStringTag,
      { value: 'Module' },
    ),
  ),
  ...
  ge = { logoutTip: '温馨提醒', logoutMessage: '是否确认退出系统?', menuLoading: '菜单加载中...' },
  be = {
    tableTitle: '错误日志列表',
    tableColumnType: '类型',
    tableColumnDate: '时间',
  ...
  he = {
    ...
    signInTitle: 'Pocobo中心计划',
    signInDesc: '数字资产，安全，互联',
    policy: '我同意xxx隐私政策',
  ...
  He = { api: pe, app: ge, errorLog: be, exception: Te, lock: fe, login: he },
  Re = Object.freeze(
    Object.defineProperty(
      {
        __proto__: null,
  ...
  qe = Ue,
  We = { placeholder: '请选择时间', rangePlaceholder: ['开始时间', '结束时间'] },
  xe = We,
  _e = {
    lang: i(
      {
    ...
    timePickerLocale: i({}, xe),
  };
_e.lang.ok = '确定';
const d = _e,
  e = '${label}不是一个有效的${type}',
  Ve = {
    locale: 'zh-cn',
    Pagination: we,
    DatePicker: d,
  ...
  m = Ve,
  u = Object.assign({
    './zh-CN/antdLocale/DatePicker.json': $e,
    './zh-CN/common.json': De,
    './zh-CN/component.json': ze,
    './zh-CN/layout.json': Be,
    './zh-CN/routes/basic.json': Ee,
    './zh-CN/routes/dashboard.json': Oe,
    './zh-CN/routes/demo.json': Ye,
    './zh-CN/sys.json': Re,
  }),
  Xe = {
    message: l(r({}, s(u, 'zh-CN')), {
      antdLocale: l(r({}, m), {
        DatePicker: Ce(m.DatePicker, s(u, 'zh-CN').antdLocale.DatePicker),
      }),
    }),
  };
